package com.mio.netty.chat.common;
...
import com.mio.netty.chat.modul.ChatMessage;
...
public class TextWebSocketFrameHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
	 ...
	 private static final Logger loger = LoggerFactory.getLogger(TextWebSocketFrameHandler.class);
